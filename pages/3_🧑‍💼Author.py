...
graph.edge('ML with NLP for accelerating cleaning process','SQL Queries')
graph.edge('SQL Queries','EDA and cleaning the substances in the inputs market')
graph.edge('EDA and cleaning the substances in the inputs market','work on manager\'s assigned')
